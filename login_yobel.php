...
<div class="row m-0 justify-content-center align-items-center" style="height: 100vh; background-size: cover; background-image: url('<?= base_url_yobel('/assets_yobel/image/mahiru.png') ?>');">
  <div class="col-md-4">
    <div class="card">
      <div class="card-header">
        <h4 class="card-title text-center">Login Pengaduan</h4>
      </div>
      <div class="card-body">
        <div class="row">
